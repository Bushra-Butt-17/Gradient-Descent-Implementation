...
Here's the corrected **README** with properly formatted equations for the **Cost Function (MSE)** and the **Gradient Descent** update rule in Markdown. I will ensure that the equations are properly displayed using LaTeX-style formatting, which should work when viewed on platforms like GitHub.
